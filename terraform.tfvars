parameters = {
  ...
  "docdb.dev.endpoint" = {
    type = "String", value = "dev-docdb-cluster-instance-1.c762eeqqau0n.us-east-1.docdb.amazonaws.com"
  }
  "rds.dev.master_username" = { type = "String", value = "devadmin" }
  "rds.dev.database_name" = { type = "String", value = "dummy" }
  "user.dev.REDIS_HOST" = {
    type = "String", value = "dev-redis-elasticache-cluster.5cb9ga.0001.use1.cache.amazonaws.com"
  }
  "cart.dev.REDIS_HOST" = {
    type = "String", value = "dev-redis-elasticache-cluster.5cb9ga.0001.use1.cache.amazonaws.com"
  }
  ...
  "shipping.dev.DB_HOST" = {
    type = "String", value = "dev-mysql-rds-cluster.cluster-c762eeqqau0n.us-east-1.rds.amazonaws.com"
  }
  ...
  "elasticsearch.password" = { type = "SecureString", value = "z8o3qnO8VJ_B3PiH7ku9" }
